...
if [ ! -L /var/www/html/static/genedive/json/drug_id.json              ]; then ln -s /usr/local/genedive/data/sources/all/drug_id.json               /var/www/html/static/genedive/json/drug_id.json;              fi
