...
class Login extends Test {
	...
	execute() {
		return new Promise( async ( resolve, reject ) => {
			try {
				// Attempt access prior to logging in (should fail)
				await this.gotoSearchPage();
				if( this.pageIsSearchPage() { reject( 'Able to access search without logging in first' ); }
				...
				await this.gotoSearchPage();
				if( this.pageIsSearchPage() { reject( 'Able to access search after logging out' ); }
