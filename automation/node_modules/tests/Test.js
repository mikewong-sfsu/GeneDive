...
class Test {
	...
	// ============================================================
		...
		this.page.is = {
			search: () => { return this.pageMatch( /\bsearch.php$/ ); },
			index:  () => { return this.pageMatch( /\bindex.php$/ ); }
		};
		this.goto = {
			search: () => { return this.navigate( `${this.options.url}/search.php` ); },
			index:  () => { return this.navigate( `${this.options.url}/index.php` ); },
		};
	}
	...
	*/
	...
	// ============================================================
		return new Promise( async( resolve, reject ) => {
			try {
				...
				if( ! this.page.is.search()) { reject( 'Login not redirected to search page' ); }
				resolve();
	...
	// ============================================================
		return new Promise( async ( resolve, reject ) => {
			try {
				...
				if( ! this.page.is.index()) { reject( 'Logout not redirected to landing page' ); }
				resolve();
	...
	searchMode( mode ) {
		return new Promise( async ( resolve, reject ) => { 
			try { 
				if( ! this.page.is.search()) { reject( 'Search not directed to search page' ); }
