	...
	searchMode( mode ) {
		return new Promise( async ( resolve, reject ) => { 
			try { 
				...
				await this.page.waitFor( 2000 ); // MW WORKAROUND: cache loading should fire events
	...
	// ============================================================
		...
		return new Promise( async ( resolve, reject ) => {
			...
			try {
				...
				await this.page.waitFor( 2000 ); // MW WORKAROUND: wait for server response to query
