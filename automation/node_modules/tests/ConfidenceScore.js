/**
 * @class      ConfidenceScoreThreshold
...
class ConfidenceScoreThreshold extends mix( Test ). with( ConfidenceScore, Table ) {
	...
	execute(){
		return new Promise( async ( resolve, reject ) => {
			try {
				...
				resolve( 'Confidence score thresholding feature works as tested' );
			} catch( e ) {
				reject( e );
			}
		});
...
module.exports = ConfidenceScoreThreshold;
