...
<?php if( is_local_client()): ?>
    ...
    <li class="dropdown-item" style="cursor: pointer;"><a class="datasource-add" href="datasource/add.php" data-toggle="tooltip-initial" title="Import your own DGR interaction data."><span class="fas fa-database"></span><span class="fas fa-plus-square" style="font-size: 8pt; margin-left: 1px"></span> Add Data Source</a></li>
    <li class="dropdown-item" style="cursor: pointer;"><a class="datasource-remove" href="datasource/remove.php" data-toggle="tooltip-initial" title="Remove a DGR interaction datasource."><span class="fas fa-database"></span><span class="fas fa-minus-square" style="font-size: 8pt; margin-left: 1px"></span> Remove Data Source</a></li>
