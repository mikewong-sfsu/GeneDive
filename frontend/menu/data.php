...
<?php if( is_local_client()): ?>
    ...
    <li class="dropdown-item" style="cursor: pointer;"><a id="apply-plugin"  data-toggle="tooltip-initial" title="Write code to use plugins on the datasource."><span class="fas fa-database"></span><span class="fas fa-file-code" style="font-size: 8pt; margin-left: 1px"></span>Add Data Source Plugins</a></li>
