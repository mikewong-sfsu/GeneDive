<div class="menu dropdown">
  ...
  <ul class="dropdown-menu dropdown-menu-right" style="margin-left: 20px; min-width: 200px;">
...
<?php if( file_exists( 'static/genedive/docker/images/genedive-docker.gz' )): ?>
    <li class="dropdown-header">Importing User Data<br>&nbsp;with GeneDive Docker</li>
    <li class="dropdown-item" style="cursor: pointer;"><a class="docker" data-toggle="tooltip-initial" href="download.php" title="Download the GeneDive Docker image. The GeneDive Docker image will allow you to import your own structured DGR data for search and visualization in GeneDive." target="_blank"><span class="fab fa-docker"></span> GeneDive Docker</a></li>
<?php endif; ?>
    <li class="divider" role="separator"></li>
