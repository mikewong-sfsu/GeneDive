...
/**
 @class		SortingColumn
 @brief		Test to check if each column is sorted.
 @params    SortingType =  ASC, DESC
 @authors	Vaishali Bisht vbisht1@mail.sfsu.edu
 @ingroup	tests
*/

class SortingColumnFeature_Mixin{

    validateSortingColumn(PAGE, SORTING_TYPE = 'ASC') {
...
module.exports = SortingColumnFeature_Mixin;
